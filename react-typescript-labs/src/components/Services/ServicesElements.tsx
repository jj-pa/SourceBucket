...
export const ServicesCard = styled.div<Props>`
  background: #fff;
  display: flex;
  flex-direction: column;
...
export const ServicesH1 = styled.h1<Props>`
  font-size: 2.5rem;
  color: #fff;
  margin-bottom: 64px;
...
export const ServicesH2 = styled.h2<Props>`
  font-size: 1rem;
  margin-bottom: 10px;
`;

export const ServicesP = styled.p<Props>`
  font-size: 1rem;
  text-align: center;
`;
